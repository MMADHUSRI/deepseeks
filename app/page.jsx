  ...
  return (
    <div>
        ...
        <Sidebar expand={expand} setExpand={setExpand} />   
          <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 pb-[#292a2d] text-white relative">
          ...
          <PromptBox isLoading={isLodaing} setIsLodaing={setIsLoading} />
